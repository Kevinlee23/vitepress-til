...
export const markDate: MarkDate = {
  ...
  'APRI': [1, 2, 3, 7, 8, 9, 10, 10, 11, 15, 16]
}

export const markData: MarkData = {
  'APRI': [
    { title: "CORS （跨域资源共享）", link: '/http/CORS', tagName: "HTTP", createDate: '2024-04-16' },
    { title: 'Docker 系列 6篇基础笔记', link: '/docker/docker-basic', tagName: 'Docker', createDate: '2024-04-15' },
