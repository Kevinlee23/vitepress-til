<template>
  ...
  >
    ...
    >
      ...
      <div
        class="w-fit px-[6px] py-[2px] rounded-[4px] border-[1px] border-white text-[16px] cursor-pointer hover:bg-[#2c9678] hover:border-[#2c9678]"
        @click="handleScroll"
      >
        开始阅读
      </div>
...
import wallpage from "../assets/images/wallhaven-vqkdo5.jpg";
