...
好看的 `vitepress` 自定义主题一则：
[Clark Cui](https://visionary-sunflower-dc7ae3.netlify.app/) / [github](https://github.com/clark-cui/vitepress-blog-zaun)

## 2024-10-08

谈 AI:

- 我们真正受益的往往是更好的结果，而不仅仅是更快的结果

-- [《我对 AI 感到厌倦》](https://www.ontestautomation.com/i-am-tired-of-ai/)

谈博客：

- 我写博客是为了自己，不一定是为了给别人看
- 我写博客这么长时间的原因之一是，我可以随笔摆弄博客的技术栈。我曾多次改变技术栈，从选择我想学习的语言，到“就是能用”的枯燥设置，然后再回来

-- [《为什么 15 年后我仍在写博客》](https://www.jonashietala.se/blog/2024/09/25/why_i_still_blog_after_15_years/)
...
- 从影响认知的角度来看。社交推荐和信息流主要起到一个认识工具的作用，它影响认知改变的感性阶段。搜索主要起到一个决策工具的作用，它影响认知改变的理性阶段。搜索要解决决策中的效率问题，简言之，要 **“去伪存真”** 和 **“变粗为精”**
  - 前者讲的是要对信息的质量以及背后的服务质量进行甄别和清除，专业上这叫做召回
  - 后者讲的是对相对优质的或相对准确的信息进行强化展示或增加辅助判断信息，专业上这叫做排序
- 内容产品分析 ![about-content-product](/images/about-content-product.jpeg)
- 人的职业生涯可以分成两段，第一段提升技能，第二段提升认知。技能的提升是为提升认知找到门路 (`技术人才 -> 管理人才`)
- 投入和专注是不同的品质
  - 投入是爆发力，在很短时间内积蓄到力量，攻克焦点问题。专注是持久力，在很长的时间内周期的发力，发掘和解决系列的问题
  - 做技术需要较高投入度，来解决许多的棘手难题。做产品需要较高专注度，来发现很难发现的问题，解决很难解决的问题

-- [啃饼关于圈子的思考](https://www.pmthinking.com/df7247fe10b0436080eb47e0ba180f87)
...
- Microfeatures I Love in Blogs and Personal Websites:
  ...
  - `Rss Feeds.`
  - -- `danilafe.com`
- 这些特征让我想到了 [Cali](https://cali.so/) 的博客，设计感很强

谈写作、记录：

- 将写作、记录做为长期主义的事来做，我认为你所使用的工具（blog, 记录工具如：typora, obsidian, 和 notion）和装潢得足够的简单，使你将时间和注意力放在写作本身。
- [Owen](https://www.owenyoung.com/), [Ant Fu](https://antfu.me/posts) 等人的博客是个很好的例子。网站重视功能和布局不至于繁杂，内容丰富、详实且广度足够。
